"""
Pass and interception event detection.

Events are classified by comparing consecutive ball-holders:

* **Pass** — possession changes between two players on the *same* team.
* **Interception** — possession changes between two players on *different* teams.
"""
