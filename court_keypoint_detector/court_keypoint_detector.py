"""
Court keypoint detection using a YOLO-pose model.

The model predicts 18 keypoints corresponding to known reference locations
on a standard basketball court (corners, free-throw lines, centre line, etc.).
"""
